...
def main():
    mlflow.set_experiment("oilspill_unet_segmentation")
    ...
    output_dir = "C:/Users/Bruna/Documents/repos/oil_spill_segmentation/data/test_data/output_mlflow"
    ...
    model.cpu()  # necessário para evitar erro de CUDA ao salvar
    mlflow.pytorch.log_model(model, "final_model")

    # Log das figuras
    mlflow.log_artifact(os.path.join(output_dir, "loss_curve.png"))
    mlflow.log_artifact(os.path.join(output_dir, "metrics_curve.png"))
